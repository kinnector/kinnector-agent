fn main() {
    ...
    #[cfg(windows)]
    {
        // Tell cargo where to find the compiled C++ import library (.lib)
        println!("cargo:rustc-link-search=native=C:\\Users\\user\\Documents\\kinnector\\kinnector-core\\build\\lib\\Release");
